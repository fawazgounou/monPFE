...
class CoteGaucheB extends StatefulWidget {
  const CoteGaucheB({Key? key}) : super(key: key);

  @override
  State<CoteGaucheB> createState() => _CoteGaucheBState();
}

class _CoteGaucheBState extends State<CoteGaucheB> {
